...
@RestController
@RequestMapping("/api/school-kafka")
public class SchoolKafkaResource {
    private final Logger log = LoggerFactory.getLogger(SchoolKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public SchoolKafkaResource(KafkaProperties kafkaProperties) {
